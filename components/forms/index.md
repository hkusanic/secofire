  ...
  <body>
		...
		<div id="main_content_wrap" class="outer">
			<section id="main_content" class="inner">
				...
				<p>Forms are composed of multiple area components. Components are created using Angular Material library</p>
				...
				<div class="picturePlaceHolder">
					<img src="https://hkusanic.github.io/secofire/images/form_small.png" alt="Section element">
				</div>
			</section>
		</div>
		{% include footer.html %}
