  ...
  <body>
	...
	<div id="main_content_wrap" class="outer">
		<section id="main_content" class="inner">
			...
			<p><code>{% highlight html lineos %}<body>{% endhighlight %}</code> element tag must use <code>layout="column"</code> attribure in addition with <code>flex</code> attribute.</p>
